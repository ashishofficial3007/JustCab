...
<?php include('header.php'); ?>
		 ...
		 <div class="container clearfix " style="height:480px !important;">
				<div class="col-md-12 ">
					<div class="col-md-4">
					</div>
					<!-- sign up body div -->
					<div class="col-md-4 sign_up_body_color gap" id="signup_div" style="height:460px;">
					<form id="signup_form" method="post" action="save_new_user.php">
					<h5><font color="white">New customer pls register here.</font></h5>
						...
						<div class="col-md-6 nopad gap">
							<input class="btn-success btn" type="submit" value="Sign up"  id="sign_up" />
						</div>
					</div>
					</form>
