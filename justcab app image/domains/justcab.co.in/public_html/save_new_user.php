...
//savedata program
	...
	require_once("dbconnect.php");
	 ...
	 $sql="select * from user where email='".$_POST['email']."' or mobile='".$_POST['phone']."'";
	...
	$sql="insert into user (firstname,lastname,email,mobile,password,address) values('".$_POST['first_name']."','".$_POST['last_name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['new_password']."','".$_POST['customer_address']."')";
